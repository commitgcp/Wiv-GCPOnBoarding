...
if command -v xdg-open >/dev/null 2>&1; then
    ...
    echo ""
    echo "https://ssh.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/commitgcp/Wiv-GCPOnBoarding.git&cloudshell_git_branch=onboarding-improvements&cloudshell_tutorial=tutorial.md"
    echo ""
    exit 1
fi

# Cloud Shell tutorial URL
TUTORIAL_URL="https://ssh.cloud.google.com/cloudshell/editor?cloudshell_git_repo=https://github.com/commitgcp/Wiv-GCPOnBoarding.git&cloudshell_git_branch=onboarding-improvements&cloudshell_tutorial=tutorial.md"
